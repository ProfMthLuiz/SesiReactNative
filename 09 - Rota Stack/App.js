...
// Páginas
import Home from "./src/pages/Home"; // Importa o componente Home da pasta "./src/pages/Home".
import Sobre from "./src/pages/Sobre"; // Importa o componente Sobre da pasta "./src/pages/Sobre".
...
export default function App() {
  return (
    <NavigationContainer> {/* Componente fornecido pelo React Navigation para envolver a navegação da aplicação. */}
      <Stack.Navigator initialRouteName="Home"> {/* Componente Navigator do navegador de pilha. initialRouteName define a rota inicial da navegação. */}
        <Stack.Screen name="Home" component={Home} /> {/* Define uma tela com o nome "Home" e associa o componente Home a ela. */}
        <Stack.Screen name="Sobre" component={Sobre} /> {/* Define uma tela com o nome "Sobre" e associa o componente Sobre a ela. */}
      </Stack.Navigator>
    </NavigationContainer>
  );
}
